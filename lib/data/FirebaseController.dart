...
class FireAppController {
  Future<void> init() async {
    await FirebaseApp.configure(
      name: SecurityData.FIREBASE_NAME,
      options: const FirebaseOptions(
        googleAppID: SecurityData.FIREBASE_GOOGLE_APP_ID,
        apiKey: SecurityData.FIREBASE_API_KEY,
        databaseURL: SecurityData.FIREBASE_DATABASE_URL,
      ),
    );
  }
}
