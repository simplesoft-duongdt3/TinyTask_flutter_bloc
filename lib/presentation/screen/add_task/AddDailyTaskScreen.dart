...
class _AddDailyTaskScreenState extends State<AddDailyTaskScreen> {
  ...
  final AddTaskScreenBloc _addTaskScreenBloc = diResolver.resolve();
    ...
    return BlocListener(
      ...
      listener: (BuildContext context, AddTaskState state) {
        if (state is SuccessState) {
          ...
          hideProgressingDialog();
          _showUserWarning("Create task fail!");
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            new FlatButton(
              ...
              onPressed: () async {
                Navigator.of(context).pop();
                _addTaskScreenBloc.dispatch(AddDailyTaskEvent(addEventPresentationModel));
              },
            ),
          ],
        );
